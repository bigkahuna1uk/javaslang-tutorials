...
public class FunctionsLiftingTest {
    ...
    {
        Function2<Integer, Integer, Option<Integer>> lifted = Function2.lift(this::sumOnlyAllowsPostiveParameters);
    ...
    private int sumOnlyAllowsPostiveParameters(int first, int second) throws RuntimeException {
        if (first < 0 || second < 0) {
